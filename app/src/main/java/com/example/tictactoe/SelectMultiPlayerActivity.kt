...
class SelectMultiPlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Populate spinner
        // TODO - populate with names from game data file when implemented (make sure to take any
        //  already selected player names out of the player list for the dropdown menu)
        val spinnerPlayerOne = binding.spinnerPlayerOneName
        val spinnerPlayerTwo = binding.spinnerPlayerTwoName

        val adapter = ArrayAdapter(this, R.layout.spinner_item, resources.getStringArray(R.array.simpleTest))
        adapter.setDropDownViewResource(R.layout.spinner_dropdown_item)
        spinnerPlayerOne.adapter = adapter
        spinnerPlayerTwo.adapter = adapter
